...
import { IoLayersOutline, IoInformationCircleOutline, IoCloudDownloadOutline, IoCalendarOutline, IoDocumentOutline } from 'react-icons/io5';

interface ElevationUploadFormProps {
  selectedYear: number;
...
const ElevationUploadForm: React.FC<ElevationUploadFormProps> = ({
  selectedYear,
  onYearChange,
  onFileChange,
  minElevation,
  ...
  const downloadCsvTemplate = () => {
    ...
    link.href = "/volume_efektif_format.csv";
    link.setAttribute("download", "volume_efektif_format.csv");
    ...
    <Card className="shadow-2xl border-0 rounded-2xl overflow-hidden">
      <CardHeader className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-8">
        <CardTitle className="text-xl flex items-center space-x-3">
          ...
          <span>Volume Efektif Data Upload</span>
        </CardTitle>
      </CardHeader>
        ...
        <Alert variant="default" className="bg-blue-50 border-blue-200 rounded-xl">
          ...
          <AlertDescription className="text-blue-800">
            ...
            <ul className="list-disc pl-4 space-y-2 text-sm">
              ...
              <li>Rentang elevasi valid: {minElevation} - {maxElevation} mdpl</li>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-500 flex items-center space-x-1">
              <span>💡</span>
              <span>File CSV berisi data elevasi dan volume efektif waduk</span>
            </p>
          </div>
        </div>
      </CardContent>
...
export default ElevationUploadForm; 